...
/**
 * Example command that moves the motor relative to its current position. For example, if the motor
 * is at 5 rotations and you call this with 2, it will move to 7 rotations.
 */
