...
public final class Constants {
  ...
  public static class KrakenConstants {
    ...
    // CANivore name - leave empty for default CAN bus, or specify your CANivore name like
    // "canivore1"
    ...
    public static final double GEAR_RATIO =
        (1.0 / 3.0) * (22.0 / 60.0); // = 0.1222 (arm rotations per motor rotation)
    ...
    public static final double MAX_VELOCITY =
        60.0; // Cruise speed (motor rotations/second) - increased for faster movement
    public static final double MAX_ACCELERATION =
        120.0; // How quickly it speeds up/slows down (motor rot/sec²) - increased for snappier
    // response
    public static final double MAX_JERK =
        2400.0; // Smoothness of acceleration changes (motor rot/sec³)
  ...
  public static class VisionConstants {
    ...
    public static final double APRILTAG_TARGET_POSITION =
        15.0; // Position to go to when tag 15 is seen
  }
