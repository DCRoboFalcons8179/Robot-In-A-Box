...
public class KrakenSubsystem extends SubsystemBase {
  ...
  /**
   * Set the mechanism to a target position (in mechanism rotations) Automatically converts to motor
   * rotations based on gear ratio Uses Motion Magic for smooth, speed-limited movement
   *
  ...
  /**
   * Set the mechanism to run at a constant speed (velocity control) Automatically converts to motor
   * velocity based on gear ratio Uses acceleration limiting and FOC for smooth operation
   *
